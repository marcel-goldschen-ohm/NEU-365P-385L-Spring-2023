...
- Jan 24 T - [Probability distributions of random variables](), HW: [Probability distributions](/assignments/prob-dist-hw.ipynb)
    - :clapper: [Probability density and normal distribution](https://www.youtube.com/watch?v=CVjr-Dox3Ck)
    - :clapper: [Standard error](https://www.youtube.com/watch?v=A82brFpdr9g&list=PLblh5JKOoLUIcdlgu78MnlATeyx4cEVeR&index=36)
- Jan 26 R - [Optimization & Maximum Likelihood Estimation (MLE)](), HW: [MLE](/assignments/mle-hw.ipynb)
    - :clapper: [Probability vs. likelihood](https://www.youtube.com/watch?v=pYxNSUDSFH4)
    - :clapper: [Maximum likelihood estimation](https://www.youtube.com/watch?v=XepXtl9YKwc)
