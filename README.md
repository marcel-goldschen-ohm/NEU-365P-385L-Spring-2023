...
- Jan 24 T - [Probability distributions of random variables](), HW: [Probability distributions](/assignments/prob-dist-hw.ipynb)
    - 🎬 [Probability density and normal distribution](https://www.youtube.com/watch?v=CVjr-Dox3Ck)
    - 🎬 [Standard error](https://www.youtube.com/watch?v=A82brFpdr9g&list=PLblh5JKOoLUIcdlgu78MnlATeyx4cEVeR&index=36)
