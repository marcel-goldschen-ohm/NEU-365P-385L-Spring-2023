...
- Jan 10 T - [Python ecosystem](/python-ecosystem.pptx) & [Python basics 1](/python-basics-1/python-basics-1.ipynb), HW: [Python basics](/assignments/hw-python-basics.ipynb)
...
- Feb 02 R - [Bootstrap]() & [Permutation test](), HW: [bootstrap & permutation test](/assignments/hw-bootstrap-permutation.ipynb)
- Feb 07 T - [Numba]() & [Python basics 3: Classes & modules](/python-basics-3.ipynb), HW: [Numba](/assignments/hw-numba.ipynb)
