...
- Jan 12 R - [Python basics 2: Lists & functions](/python-basics-2.ipynb), HW: [List slicing & iteration](/hw-list-index-iter.ipynb)
...
- Feb 02 R - [Bootstrap]() & [Permutation test](), HW: [bootstrap & permutation test](/hw-bootstrap-permutation.ipynb)
- Feb 07 T - [Numba]() & [Python basics 3: Classes & modules](/python-basics-3.ipynb), HW: [Numba](/hw-numba.ipynb)
